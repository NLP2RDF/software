...
import org.nlp2rdf.implementation.opennlp.NIFNameSampleStreamFactory.Parameters;
...
public class NIFSentenceSampleStreamFactory extends
	...
	public static void registerFactory() {
		StreamFactoryRegistry.registerFactory(SentenceSample.class, NIF_FORMAT,
		    new NIFPOSSampleStreamFactory(Parameters.class));
	}

	protected <P> NIFSentenceSampleStreamFactory(Class<P> params) {
		super(params);
	}
	...
	public ObjectStream<SentenceSample> create(String[] args) {
		...
		try {
			...
			ObjectStream<Resource> res = new TypedRDFResourceStream(model,
					NIFOntClasses.Context.getOntClass(model));

			return new NIFSentenceSampleStream(res);
