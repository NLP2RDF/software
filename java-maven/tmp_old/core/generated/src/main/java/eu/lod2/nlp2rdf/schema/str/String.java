 ...
 */
public class String extends IndividualImpl implements IString {

	private static Log log = LogFactory.getLog(String.class);
	...
	static final public Implementation factory = new Implementation() {
		...
		public EnhNode wrap(Node n, EnhGraph eg) {
			if (canWrap(n, eg)) {
				return new String(n, eg);
			} else {
				log.warn("Cannot convert node " + n.toString() + " to  String");
				return null;
			}
		}
	 ...
	 */
	static final public Filter<String> nullFilter = new NullFilter<String>();

	/**
	 * Mapping support for String
	 */
	public static <From> Map1<From, String> mapperFrom(Class<From> from) {
		return new Map1<From, String>() {
			@Override
			public String map1(Object x) {
				if (x instanceof Statement) {
					Resource r = ((Statement) x).getResource();
					if (r.canAs(String.class))
						return r.as(String.class);
				} else if (x instanceof RDFNode) {
					if (((RDFNode) x).canAs(String.class))
						return ((RDFNode) x).as(String.class);
				}
				return null;
			}
		};
	...
	static final public Map1<Statement, String> statementMapper = mapperFrom(Statement.class);
	static final public Map1<Individual, String> individualMapper = mapperFrom(Individual.class);
	static final public Map1<RDFNode, String> nodeMapper = mapperFrom(RDFNode.class);

	/**
	 * Generic functions from parent class
	 */
	public String(Node n, EnhGraph g) {
		super(n, g);
	}
	...
	public static void register() {
		log.debug("Registering custom class String with jena");
		BuiltinPersonalities.model.add(String.class, String.factory);
		BuiltinPersonalities.model.add(eu.lod2.nlp2rdf.schema.str.String.class, String.factory);
	}

	/**
	 * Static Functions for instance handling
	 */
	public static String get(java.lang.String uri, OntModel ontModel) {
		Individual individual = ontModel.getIndividual(uri);
		return (eu.lod2.nlp2rdf.schema.str.String) individual.as(eu.lod2.nlp2rdf.schema.str.String.class);
	}

	public static String get(java.lang.String uri) {
		return get(uri, eu.lod2.nlp2rdf.schema.tools.Factory.getDefaultModel());
	}

	public static Iterator<String> iterate(OntModel ontModel) {
		ExtendedIterator<Individual> it = ontModel.listIndividuals(eu.lod2.nlp2rdf.schema.tools.Vocabulary.String);
	...
	public static List<String> list(OntModel ontModel) {
		List<String> list = new ArrayList<String>();
		Iterator<String> it = iterate(ontModel);
		while (it.hasNext()) {
			String cls = it.next();
			list.add(cls);
		}
	...
	public static Iterator<String> iterate(boolean direct, OntModel ontModel) {
		OntClass cls = ontModel.getOntClass("http://nlp2rdf.lod2.eu/schema/string/String");
	...
	public static List<String> list(boolean direct, OntModel ontModel) {
		List<String> list = new ArrayList<String>();
		Iterator<String> it = iterate(direct, ontModel);
		while (it.hasNext()) {
			String cls = it.next();
			list.add(cls);
		}
	...
	public static String create(java.lang.String uri, OntModel ontModel) {
		return (String) ontModel.createOntResource(String.class, eu.lod2.nlp2rdf.schema.tools.Vocabulary.String, uri);
	}

	public static String create(OntModel ontModel) {
		return create(null, ontModel);
	}

	public static String create(java.lang.String uri) {
